	...
	<div class="container-fluid products">
		<div class="row">
			<div class="col-xs-9">
				<nav class="navbar navbar-default">
					<div class="container-fluid">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="active"><a href="javascript:void(0);">默认排序</a></li>
							<li><a href="${proPath}/shop/bysales?shopid=${shop.shopid}">按销量</a></li>
							<li><a href="${proPath}/shop/byscore?shopid=${shop.shopid}">按评价</a></li>
				...
				<div id="cats">
					<ul class="nav nav-pills cat">
						<c:forEach items="${shop.productCats}" var="cat">
							<li role="presentation"><a href="#cat${cat.pdcatid}">${cat.name}</a></li>
						</c:forEach>
					</ul>
				</div>
					...
					<div class="panel-body">
						<div class="container-fluid">
							<c:forEach items="${shop.productCats}" var="cat">
								<div class="row">
									<div class="col-sm-12">
										<h2 id="cat${cat.pdcatid}">${cat.name}</h2>
									</div>
